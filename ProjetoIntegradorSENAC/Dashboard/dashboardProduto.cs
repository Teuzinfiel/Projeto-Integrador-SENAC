...
namespace ProjetoIntegradorSENAC.Dashboard
{
    public partial class dashboardProduto : Form
    {
        ...
        private void dashboardProduto_Load(object sender, EventArgs e)
        {
        ...
        {
            func_dashboard.carregarInfoProdutos(lbDash1, lbDash2, lbDash3, lbDash4, param_idEmpresa);
            func_dashboard.load_grafico_produtos(grafico1, grafico2, param_idEmpresa, lbTituloGrafico1,lbTituloGrafico2);
